...
from tkinter import Entry, Scale, Checkbutton, IntVar
...
class GUI:
    def __init__(self, winroot):
        ...
        self.bt_connect_camara.place(x=17,y=105)
        ...
        self.lb_image_detected = tk.Label(self.fr_data_personal, image=self.ph_image_detected)
    ...
    def plug_camera(self, ip_camara1, ip_camara2):
        ...
        if not self.flag_video_capture:
            ...
            if  ip_camara1 is not None: self.cap1 = cv2.VideoCapture(0)
